...
// Stub feature-registry auto-imports (auto-imported from server/utils/feature-registry.ts)
vi.stubGlobal('registerFeature', vi.fn())
vi.stubGlobal('recordEdge', vi.fn())
vi.stubGlobal('incrementInvocations', vi.fn())
vi.stubGlobal('incrementLogCount', vi.fn())
vi.stubGlobal('getRegistry', vi.fn(() => ({ features: [], edges: [] })))
vi.stubGlobal('clearRegistry', vi.fn())

// Stub feature-registry-db auto-imports (auto-imported from server/utils/feature-registry-db.ts)
vi.stubGlobal('getFeatureRegistryDb', vi.fn(() => null))
vi.stubGlobal('syncRegistryToDb', vi.fn())
vi.stubGlobal('syncFileMappings', vi.fn())
