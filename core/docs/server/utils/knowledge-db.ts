...
// Feature registry read functions (queryFeatureRegistry, queryFeatureEdges, queryFileMappings)
// are now in core/server/utils/feature-registry-db.ts and auto-imported from there.
